...
\author{Gabriel Alexandre Linhares Calper Seabra}  % Seu nome
\authorbib{Calper, Gabriel} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Analisador acústico de gases} % Título do trabalho
\titleen{Acoustic gas analyzer} % Título traduzido para inglês
\advisor{Luiz Fernando Copetti} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
% Se não houver corientador, comente a linha a baixo
\coadvisor{Luiz Marcos de Lira Faria
} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
...
\PalavraChaveA{Transformada R\'apida de Fourier}%% Palavra-chave A
\PalavraChaveB{Sistemas Embarcados}%% Palavra-chave C
\PalavraChaveC{Tubo de Kundt}%% Palavra-chave D
...
\KeywordA{Fast Fourier Transform}%% Keyword A
\KeywordB{Embedded Systems}%% Keyword C
\KeywordC{Kundt Tube}%% Keyword D
